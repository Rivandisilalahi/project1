...
function scrollToBottom() {
  ...
  const scrollStep = Math.ceil(scrollHeight / 400); 
  
   const music = document.getElementById('music');
  music.play(); 
  
  function scrollToBottomStep() {
  // Tambahkan kondisi di sini untuk menghentikan scroll pada bagian tertentu
  
  // Contoh: jika posisi scroll mencapai 500px, hentikan scroll
  if (window.scrollY >= 1850) {
    return;
  }
  
  // Jika belum mencapai posisi yang diinginkan, lanjutkan scroll
  if (window.scrollY < scrollHeight - windowHeight) {
    window.scrollBy(0, scrollStep); 
    setTimeout(scrollToBottomStep, 20);
  } else {
